...
public abstract class AbstractApplicationContext extends DefaultResourceLoader
	...
	/**
	 * Flag that indicates whether this context is currently active. 设置当前容器是激活状态还是关闭状态
	 */
	...
	/**
	 * Synchronization monitor for the "refresh" and "destroy". 同步器  就是为了防止刷新或者销毁容器被中断
	 */
	...
	protected void prepareRefresh() {
		...
		// to be published once the multicaster is available... 允许收集刷新前的ApplicationEvent
	 ...
	 * 将实现 ApplicationListener 的 Bean 添加为侦听器。不会影响其他侦听器，这些侦听器可以在不成为 bean 的情况下添加
	 */
